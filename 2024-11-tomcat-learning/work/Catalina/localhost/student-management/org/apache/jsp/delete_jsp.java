 ...
 * Generated at: 2024-10-25 07:41:20 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (student_number != null && !student_number.isEmpty()) {
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mariadb://localhost:3306/studentdb", "root", "123456");
            ...
            out.println("<script>alert('发生错误：" + e.getMessage() + "'); window.location='index.jsp';</script>");
        }
    } else {
